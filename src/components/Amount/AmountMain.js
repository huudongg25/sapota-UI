...
class AmountMain extends Component {
    ...
    render() {
        ...
        return (
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="pricing-wrapper single-pricing text-center mb-30">
                                ...
                                <div className="pricing-button">
                                    <a href="#"> <span className="pricings-button">select plan <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6">
            ...
            {/* <!-- pricing-area-start --> */}
            <div className="pricing-area pt-120 pb-100" style={{ backgroundImage: 'url(assets/img/bg/bg-10.jpg)'}}>
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div className="blog-wrapper blog-2-wrapper">
                                ...
                                <div className="blog-meta">
                                    <span> <i><FontAwesomeIcon icon={['fas', 'user']} /></i> Soamlia</span>
                                    <span> <i><FontAwesomeIcon icon={['fas', 'calendar-week']} /></i> 05 Aug 2019</span>
                                    <span> <i><FontAwesomeIcon icon={['fas', 'comments']} /></i> (03)</span>
                                </div>
                                <div className="blog-text">
                                    <h3><a href="blog-details.html">Monthly Web Development To Update React Hooks Cons</a></h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque </p>
                                    <a href="blog-deatils.html"> <span className="blog-button">read more <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div className="blog-wrapper blog-2-wrapper">
                                ...
                                <div className="blog-text">
                                    <h3><a href="blog-details.html">Detailed Comparison Between WordPress & October CMS</a></h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque </p>
                                    <a href="blog-deatils.html"> <span className="blog-button">read more <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                </div>
                            </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div className="blog-wrapper blog-2-wrapper">
                                ...
                                <div className="blog-text">
                                    <h3><a href="blog-details.html">Exploring Latest Web Design Together With Theme</a></h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque </p>
                                    <a href="blog-deatils.html"> <span className="blog-button">read more <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                </div>
                            </div>
