    ...
    render() {
        return (
            ...
            <div className="goals-area pos-rel">
                <div className="goals-img d-none d-lg-block" style={{ backgroundImage: 'url(assets/img/goals/03.jpg)'}}></div>
                <div className="container">
                    <div className="row">
                    ...
                    <div className="row">
                       ...
                       <div className="col-xl-5 col-lg-5">
                            <div className="cta-button text-lg-right mb-30">
                                <a className="btn btn-white btn-none" href="#"><span className="btn-text">join with us <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                <a className="cta-link" href="#"><i><FontAwesomeIcon icon={['fas', 'phone-alt']} /></i> (+84) 38 339 6560</a>
                            </div>
                       </div>
                    </div>
                </div>
