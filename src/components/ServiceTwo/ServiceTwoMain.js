...
class ServiceTwoMain extends Component {
    ...
    render() {
        ...
        return (
            <main>
            {/* <!-- services-area-start --> */}
            <div class="services-area pt-130 pb-100">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div class="single-services text-center">
                                ...
                                <div class="services-text">
                                    ...
                                    <a href="#"> <span class="services-button">read more <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-10.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <a href="#">view more <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-09.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    <div class="our-services-icon">
                                        <i class="fas fa-laptop-code"></i>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-08.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    <div class="our-services-icon">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-07.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    <div class="our-services-icon">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-05.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    <div class="our-services-icon">
                                        <i class="fas fa-fingerprint"></i>
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <p>Set perspiciatis unde omnis iste  natus error sit voluptatem accusan tium demqu laudantium </p>
                                        <a href="#">view more <i class="fas fa-bullhorn"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="our-services-wrapper mb-30">
                                <div class="our-services-img">
                                    <img src="assets/img/service/ser-06.jpg" alt="" />
                                </div>
                                <div class="our-services-content">
                                    <div class="our-services-icon">
                                        <i class="fas fa-fingerprint"></i>
                                    ...
                                    <div class="our-services-text">
                                        ...
                                        <p>Set perspiciatis unde omnis iste  natus error sit voluptatem accusan tium demqu laudantium </p>
                                        <a href="#">view more <i class="fas fa-cog"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="services-button text-center mt-30">
                                <a class="btn" href="#"><span class="btn-text">view All Services <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contact-wrapper mb-30">
                                ...
                                <form action="assets/mail.php" id="contact-form">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <button class="btn" type="submit"><span class="btn-texts">send message <i><FontAwesomeIcon icon={['fas', 'long-arrow-alt-right']} /></i></span> <span class="btn-border"></span></button>
                                            </div>
                                        </div>
