    ...
    render() {
        ...
        return (
            ...
            <main>
                ...
                {newsDetails && newsDetails.map((article, num) => (
                <SiteBreadcrumb pageTitle={article.title} />
                ))}
                {/* breadcrumb-area-start */}
                                ...
                                <article className="postbox post format-image mb-40">
                                    ...
                                    <div className="postbox__text bg-none">
                                        <div className="post-meta mb-15">
                                            <span><i><FontAwesomeIcon icon={['fas', 'calendar-check']} /></i> September 15, 2018 </span>
                                            <span><a href="#"><i><FontAwesomeIcon icon={['fas', 'user']} /></i> Diboli B. Joly</a></span>
                                            <span><a href="#"><i><FontAwesomeIcon icon={['fas', 'comments']} /></i> 23 Comments</a></span>
                                        </div>
                                        <h3 className="blog-title">{article.title}</h3>
                                        <div className="post-text mb-20" dangerouslySetInnerHTML={{ __html: article.text }} />
                                        <BlogPostRelated />
                                        <BlogPostArrow />
                                    </div>
                                    <BlogPostAuthor />
