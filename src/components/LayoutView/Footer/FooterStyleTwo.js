                                ...
                                <div className="single-newsletter ">
                                    <div className="newsletter-form">
                                        <form action="#">
                                            ...
                                            <button className="btn" type="submit"><span className="btn-text">subscribe <i><FontAwesomeIcon prefix='fas' icon={'long-arrow-alt-right'} /></i></span> <span className="btn-border"></span></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-xl-8 col-lg-8 col-md-8">
                                <div className="copyright">
                                    <p><i className="far fa-copyright"></i> Copyright 2019 <a href="#">Torun</a>. All rights reserved.</p>
                                </div>
                            </div>
